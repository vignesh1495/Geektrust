...
import com.onlinemarketmaker.entities.Kingdom;
import com.onlinemarketmaker.repository.IKingdomRepository;
...
public class KingdomRepositoryTest {
    ...
    void setup() {
        ...
        kingdomRepository = new DemandRepository(kingdomMap);
    }
